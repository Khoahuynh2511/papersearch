        ...
        <div className="custom-screen items-center mx-auto md:flex">
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="font-bold text-lg">VietQR</div>
            </Link>
          ...
          >
            <ul className="text-gray-700 justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0 md:text-gray-600 md:font-medium">
              ...
              <li>
                <NavLink
                  href="/start"
                  className="block font-medium text-sm text-white bg-gradient-to-r from-red-600 to-blue-600 hover:from-red-700 hover:to-blue-700 shadow-lg transform hover:scale-105 transition-all duration-200 md:inline"
                >
                  Tạo QR Code
                </NavLink>
              </li>
